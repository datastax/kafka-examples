...
Add PostgreSQL driver to CLASSPATH and Start the Kafka Connect Worker
```
export CLASSPATH=/home/automaton/confluentinc-kafka-connect-jdbc-5.0.0/lib/postgresql-9.4-1206-jdbc41.jar
